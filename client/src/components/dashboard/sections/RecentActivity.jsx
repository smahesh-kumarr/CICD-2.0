  ...
  const handleDownloadLogs = async (activity) => {
    try {
      ...
      const logContent = {
        ...
        testing: {
          tools: activity.testingToolsArray || [],
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="flex-1">
                  ...
                  <div className="grid grid-cols-2 gap-2 mt-1">
                    ...
                    <div className="text-xs text-gray-400">
                      <span className="text-blue-400">Testing:</span> {activity.testingToolsArray?.join(', ') || 'N/A'}
                    </div>
                    <div className="text-xs text-gray-400">
          ...
          <div className="bg-gray-800 rounded-lg p-6 max-w-2xl w-full max-h-[80vh] overflow-y-auto">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-white">Testing Tools: {selectedActivity.testingToolsArray?.join(', ') || 'N/A'}</p>
